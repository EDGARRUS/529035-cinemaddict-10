export default class FilmModel {
  constructor(data) {
    ...
    this.userRating = data[`user_details`][`personal_rating`] ? parseInt(data[`user_details`][`personal_rating`], 10) : 0;
  ...
  toRAW() {
    return {
      ...
      'user_details': {
        'personal_rating': this.userRating ? parseInt(this.userRating, 10) : 0,
